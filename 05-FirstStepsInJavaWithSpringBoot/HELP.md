...
* The original package name 'br.com.erudio.rest-with-spring-boot-and-java-erudio' is invalid and this project uses 'br.com.erudio.restwithspringbootandjavaerudio' instead.
